package com.money.moneyapi.resource;
...
import com.money.moneyapi.event.RecursoCriadoEvent;
import com.money.moneyapi.exceptionhandler.MoneyApiExceptionHandler.Erro;
...
import com.money.moneyapi.service.LancamentoService;
...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> buscaPeloCodigo(@PathVariable Long codigo){
		...
		return lancamentoSalva != null ? ResponseEntity.ok(lancamentoSalva): ResponseEntity.notFound().build();
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)  //Fez o que precisa mas nao vai retornar nada
